  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Access your API projects and keys</p>
      </div>
