...
export default async function DashboardLayout({
  ...
  return (
    <div className="control-shell flex-1 w-full min-h-screen flex">
      {/* Sidebar navigation */}
      <aside className="control-sidebar w-64 fixed left-0 top-0 h-screen flex flex-col p-6 z-50">
        <div className="flex items-center gap-3 mb-10">
          ...
          <div>
            <h1 className="font-bold text-lg leading-tight text-gray-900 dark:text-white">Mocky</h1>
        ...
        <nav className="flex-1 flex flex-col gap-1.5">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-4 py-3 text-sm font-bold text-[#0052cc] bg-blue-50/50 dark:bg-blue-950/20 rounded-xl transition-colors duration-200 border border-blue-100/30 dark:border-blue-900/10"
          >
          ...
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-4 py-3 text-sm font-semibold text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-xl transition-colors duration-200"
          >
      ...
      {/* Main Content Area */}
      <div className="control-stage ml-64 flex-1 flex flex-col min-h-screen">
        {/* Top Header */}
        <header className="control-header sticky top-0 flex justify-between items-center h-16 px-8 z-40">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <button className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-full transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <main className="control-main flex-1 p-8 max-w-[1400px] w-full mx-auto">
          {children}
        </main>
      </div>
    </div>
